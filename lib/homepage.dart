...
class _HomePageState extends State<HomePage> {
  ...
  Future getAlbum() async{
    var res = await http.get(
        Uri.encodeFull('https://jsonplaceholder.typicode.com/albums/1/photos'), headers: {"Accept": "application/json"});
        ...
        child: Card(
            child:  Column(
              ...
              children: <Widget>[
                Expanded(
                  child: new Container(
                    child: CachedNetworkImage(placeholder: CircularProgressIndicator(),
                ...
                Expanded(
                  child: new Container(margin: EdgeInsets.only(left:10.0),
